...
<div class="container">
    <div class="row pt-5">
        <div class="white col-md-2 mx-auto mb-md-3 shadow py-4 px-2 align-text-right" style="border-bottom: 5px solid #457">
            <h3 class="h3-responsive mb-0 align-text-right">350</h3>
        ...
        <div class="white col-md-2 mx-auto mb-md-3 shadow py-4 px-2 align-text-right" style="border-bottom: 5px solid #1976d2">
            <h3 class="h3-responsive mb-0 align-text-right">30</h3>
            <small class="grey-text">Ongoing Sponsorships</small>
        </div>
        <div class="white col-md-2 mx-auto mb-md-3 shadow py-4 px-2 align-text-right" style="border-bottom: 5px solid #009688">
            <h3 class="h3-responsive mb-0 align-text-right">200</h3>
    ...
    <div class="row pt-3">
        <div class="col-md-6">
            <div class="row">
                <div class="col-12">
                    <h5 class="text h5-responsive">Recent Wallet Transctions</h5>
                                ...
                                <div class="col-12 p-0 overflow-x-hidden">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <small class="neg-mt-10 bold">{{$transaction->user->name}}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 shadow-lg white">
                    <div class="row p-2 p-md-4 my-3">
                        <div class="col-md-4 p-3 align-text-center">
                            <h2 class="h2-responsive text mb-0 align-text-center">80%</h2>
                            <span class="fs-14 grey-text">Sponsorship Rate</span>
                        </div>
                        <div class="col-md-7 ml-auto p-3 align-text-center">
                            <h2 class="h2-responsive text mb-0 align-text-center">&#8358;25,000,000.00</h2>
