...
?>
<a href="/sponsorships/{{$item->id}}" class="featured-card mb-3 col-md-3 p-0 ml-5 mr-auto my-4 shadow wows fadeInRight" data-wow-delay="{{ $delay }}s" data-wow-duration="4s">
